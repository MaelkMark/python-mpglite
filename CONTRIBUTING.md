...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/MaelkMark/python-mpglite/issues?q=label%3Abug).
...
Bugs are tracked as [GitHub issues](https://github.com/MaelkMark/python-mpglite/issues). If you run into an issue with the project:

- Open an [Issue](https://github.com/MaelkMark/python-mpglite/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and **not to label the issue**.)
...
- Perform a [search](https://github.com/MaelkMark/python-mpglite/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.

### How Do I Submit a Good Enhancement Suggestion?

Enhancement suggestions are tracked as [GitHub issues](https://github.com/MaelkMark/python-mpglite/issues).
